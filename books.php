...
<div class="main-container" style="padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <div>
            ...
            <p style="margin:5px 0; color: #666;">Explore our collection</p>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
        ...
        <?php if ($res->num_rows > 0): ?>
            ...
            <?php while ($row = $res->fetch_assoc()): 
                ...
                $status_text = ($row['stocks'] > 0) ? 'Available ('.$row['stocks'].')' : 'Unavailable';
            ?>
                <div class="book-card" style="background: white; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1); display: flex; flex-direction: column; transition: transform 0.3s;">
                    ...
                    <div style="background: #bababa; height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                        <?php if (!empty($row['image']) && file_exists("uploads/" . $row['image'])): ?>
                            <img src="uploads/<?php echo $row['image']; ?>" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
